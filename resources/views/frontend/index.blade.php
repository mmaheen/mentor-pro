            ...
            <div class="row align-items-sm-center align-items-lg-stretch">
                <div class="col-md-7 col-lg-7">
                    <div class="learning_img">
                        <img src="{{ asset('assets/frontend') }}/img/learning_img.png" alt="">
                    </div>
                </div>
    ...
    <section class="special_cource padding_top">
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="single_special_cource">
                            ...
                            <div class="special_cource_text">
                                ...
                                <p>{{Str::limit( $course->description, 75)}}</p>
                                <div class="author_info">
                                    <div class="author_img">
                                        @if ($course->user->image == null)
                                            <img src="{{ asset('assets/frontend/img/default_user.jpg') }}" height = "50px" width = "50px" class = "rounded-circle" alt="">
                                        @else
                                            <img src="{{ asset('uploads/users/'.$course->user->image) }}" alt="" height="50px" class = "rounded-circle" width="50px">  
                                        @endif
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="single_special_cource">
                        <img src="{{ asset('assets/frontend') }}/img/special_cource_2.png" class="special_img" alt="">
                        <div class="special_cource_text">
                            ...
                            <div class="author_info">
                                <div class="author_img">
                                    <img src="{{ asset('assets/frontend') }}/img/author/author_2.png" alt="">
                                    <div class="author_info_text">
                                        <p>Conduct by:</p>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="single_special_cource">
                        <img src="{{ asset('assets/frontend') }}/img/special_cource_3.png" class="special_img" alt="">
                        <div class="special_cource_text">
                            ...
                            <div class="author_info">
                                <div class="author_img">
                                    <img src="{{ asset('assets/frontend') }}/img/author/author_3.png" alt="">
                                    <div class="author_info_text">
                                        <p>Conduct by:</p>
                                        <h5><a href="#">James Well</a></h5>
                                    </div>
        ...
        <div class="container">
            <div class="row align-items-sm-center align-items-xl-stretch">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="learning_img">
                        <img src="{{ asset('assets/frontend') }}/img/advance_feature_img.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="textimonial_iner owl-carousel">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-2 col-sm-4">
                                    <div class="testimonial_slider_img">
                                        <img src="{{ asset('assets/frontend') }}/img/testimonial_img_1.png" alt="#">
                                    </div>
                                </div>
                        ...
                        <div class="testimonial_slider">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-2 col-sm-4">
                                    <div class="testimonial_slider_img">
                                        <img src="{{ asset('assets/frontend') }}/img/testimonial_img_2.png" alt="#">
                                    </div>
                                </div>
                                <div class="col-xl-4 d-none d-xl-block">
                                    <div class="testimonial_slider_text">
                        ...
                        <div class="testimonial_slider">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-2 col-sm-4">
                                    <div class="testimonial_slider_img">
                                        <img src="{{ asset('assets/frontend') }}/img/testimonial_img_3.png" alt="#">
                                    </div>
                                </div>
                                <div class="col-xl-4 d-none d-xl-block">
                                    <div class="testimonial_slider_text">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-blog">
                        <div class="card">
                            <img src="{{ asset('assets/frontend') }}/img/blog/blog_2.png" class="card-img-top" alt="blog">
                            <div class="card-body">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-blog">
                        <div class="card">
                            <img src="{{ asset('assets/frontend') }}/img/blog/blog_3.png" class="card-img-top" alt="blog">
                            <div class="card-body">
